...
[English](README.md) · Español · [Ejemplos ejecutables](examples/README.es.md) · [Guía de uso](https://validator.trialsur.cloud/docs/byok.html#uso) · [Reglas de campos](docs/RULES.es.md) · [Instalar una versión](docs/RELEASE.es.md) · [Resultados de evaluación](evals/RESULTS-2026-09-25.md)
