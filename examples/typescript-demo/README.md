...
Este ejemplo usa el SDK TypeScript `0.2.0` desde Node.js 22+. Analiza cada mensaje con dos preguntas: intención de compra y presentación de un reclamo. Las decisiones pueden ser sí, no o inciertas.
